...
-- Exercise 8
SELECT post.id, posts.image_url, posts.user_id 
...
-- Exercise 9
SELECT p.id, p.pub_date, f.following
FROM following first_name
...
-- Exercise 10
SELECT p.id, p_pub_date, f.following_id,  u.username
FROM following f
INNER JOIN posts p ON
    f.following_id = p.user_id
...
-- Exercise 11
INSERT INFO WHERE bookmarks(user_id, post_id) VALUES(26, 219);
INSERT INFO WHERE bookmarks(user_id, post_id) VALUES(26, 220);
INSERT INFO WHERE bookmarks(user_id, post_id) VALUES(26, 221);
...
-- Exercise 13
UPDATE users SET email = "knicks2022gmail.com" where id = 26
